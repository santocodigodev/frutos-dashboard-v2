...
export default function FinishedOrders() {
  ...
  useEffect(() => {
    const fetchOrders = async () => {
      ...
      try {
        ...
        const finishedOrders = data.filter((order: any) => order.localStatus === 'finished');
  ...
  if (loading) {
    return <LoadingDialog text="Cargando órdenes finalizadas..." />;
  }

  return (
    <div className="p-6">
      <h1 className="text-2xl font-bold text-purple-600 mb-6">Órdenes Finalizadas</h1>
              ...
              >
                <div className="flex justify-between items-start mb-2">
                  <div className="flex items-center gap-2">
                    <span className="text-purple-600">{getFormattedStatusIcon(order.localStatus)}</span>
